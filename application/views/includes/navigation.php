            ...
            <div class="container">
                ...
                <nav class="header_menu">
                    <!-- <ul class="menu">
                        <li class="current-menu-item">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="current-menu-item"><a href="index-3.html">Home 3</a></li>
                    ...
                    <?php
                            ...
                            ?>
                             <li>
                            <a href="<?php echo $navigation['link']; ?>"><?php echo $navigation['catname']; ?> <span class="fa fa-caret-down"></span></a>
                            <ul class="sub-menu">
                                <li><a href="index.html">Home 1</a></li>
